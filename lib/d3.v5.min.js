...
(function (t, n) {
  ...
  function h(t, n, e) {
    var r = (n - t) / Math.max(0, e),
      ...
      o = r / Math.pow(10, i);
    return i >= 0
      ? (o >= rs ? 10 : o >= is ? 5 : o >= os ? 2 : 1) * Math.pow(10, i)
      : -Math.pow(10, -i) / (o >= rs ? 10 : o >= is ? 5 : o >= os ? 2 : 1);
  }
  function d(t, n, e) {
      ...
      (m = m.merge(
        ...
        (S = S.merge(
          T.append("text")
            .attr("fill", "#000")
            .attr(s, c * p)
            .attr("dy", t === us ? "0em" : t === cs ? "0.71em" : "0.32em")
        )),
        e !== b &&
          ((m = m.transition(e)),
          (w = w.transition(e)),
    ...
    return (
      ...
      (e.tickArguments = function (t) {
        return arguments.length
          ? ((r = null == t ? [] : as.call(t)), e)
          : r.slice();
      }),
      (e.tickValues = function (t) {
        return arguments.length
          ? ((i = null == t ? null : as.call(t)), e)
          : i && i.slice();
      }),
  ...
  function E(t, n, e) {
    for (var r = 0, i = t.length; r < i; ++r)
      if (t[r].name === n) {
        (t[r] = hs), (t = t.slice(0, r).concat(t.slice(r + 1)));
        break;
      }
  ...
  function k(t) {
    ...
    return (
      ...
      ps.hasOwnProperty(n) ? { space: ps[n], local: t } : t
    );
  }
  function C(t) {
    var n = k(t);
      ...
      : function (t) {
          return function () {
            var n = this.ownerDocument,
              e = this.namespaceURI;
            return e === ds && n.documentElement.namespaceURI === ds
              ? n.createElement(t)
  ...
  function O(t, n, e, r, i, o, a) {
    ...
    for (u = 0; u < l; ++u)
      (f = n[u]) &&
        ((d[u] = c = bs + a.call(f, f.__data__, u, n)),
        c in s ? (i[u] = f) : (s[c] = f));
    for (u = 0; u < h; ++u)
      (f = s[(c = bs + a.call(t, o[u], u, o))])
  ...
  function it(t, n, e) {
    var r = ms.hasOwnProperty(t.type) ? nt : et;
  ...
  function Bt(t) {
    ...
    var e,
      ...
      o = Gt(t.g),
      a = Gt(t.b),
      u = jt((0.2225045 * i + 0.7168786 * o + 0.0606169 * a) / Os);
    return (
      i === o && o === a
        ? (e = r = u)
        : ((e = jt((0.4360747 * i + 0.3850649 * o + 0.1430804 * a) / qs)),
          (r = jt((0.0139322 * i + 0.0971045 * o + 0.7141733 * a) / Ys))),
  ...
  function hn(t, n) {
    var e,
      ...
      u = [],
      f = [];
    for (t += "", n += ""; (e = ol.exec(t)) && (r = al.exec(n)); )
      (i = r.index) > o &&
  ...
  function vn(t, n, e, r, i, o) {
    ...
    return (
      ...
      t * r < n * e && ((t = -t), (n = -n), (f = -f), (a = -a)),
      {
        translateX: i,
        translateY: o,
        rotate: Math.atan2(n, t) * ul,
        skewX: Math.atan(f) * ul,
        scaleX: a,
        scaleY: u,
      }
    );
    ...
    if (h < pl)
      ...
      (r = (y - g) / ll),
        (e = function (t) {
          ...
          return [i + u * s, o + u * l, (a * e) / yn(ll * n + g)];
        });
    }
  ...
  function kn(t) {
    if (!xl) {
      wl && (wl = clearTimeout(wl));
      t - Nl > 24
        ? (t < 1 / 0 && (wl = setTimeout(Sn, t - El.now() - Sl)),
          Ml && (Ml = clearInterval(Ml)))
        : (Ml || ((Tl = El.now()), (Ml = setInterval(En, Al))),
          (xl = 1),
          kl(Sn));
    }
  }
  ...
  function Pn(t, n, e, r, i, o) {
    ...
    (function (t, n, e) {
      function r(f) {
        var c, s, l, h;
        if (e.state !== Rl) return o();
        for (c in u)
          if ((h = u[c]).name === e.name) {
            if (h.state === Dl) return Cn(r);
            h.state === Ul
              ? ((h.state = Ol),
                h.timer.stop(),
                h.on.call("interrupt", t, t.__data__, h.index, h.group),
                delete u[c])
              : +c < n && ((h.state = Ol), h.timer.stop(), delete u[c]);
          }
        if (
          (Cn(function () {
            e.state === Dl &&
              ((e.state = Ul), e.timer.restart(i, e.delay, e.time), i(f));
          }),
          (e.state = Ll),
          ...
          for (
            e.state = Dl, a = new Array((l = e.tween.length)), c = 0, s = -1;
            c < l;
            ++c
          )
        ...
        for (
          var r =
              n < e.duration
                ...
                : (e.timer.restart(o), (e.state = ql), 1),
            i = -1,
            u = a.length;
          ++i < u;
      ...
      function o() {
        (e.state = Ol), e.timer.stop(), delete u[n];
  ...
  function zn(t, n) {
    var e = Ln(t, n);
    if (e.state > zl) throw new Error("too late; already scheduled");
    return e;
  }
  function Rn(t, n) {
    var e = Ln(t, n);
    if (e.state > Ll) throw new Error("too late; already started");
    return e;
  }
  function Ln(t, n) {
    ...
    function a() {
      ...
      function o() {
        ...
        p < c &&
          ...
          (c = p),
          (p = t),
          M in mh && Y.attr("cursor", bh[(M = mh[M])])),
          g < h &&
            ((N *= -1),
            (t = l),
            (l = v),
            ...
            (h = g),
            (g = t),
            M in xh && Y.attr("cursor", bh[(M = xh[M])])),
      ...
      if (s.apply(this, arguments)) {
        ...
        "overlay" === M
          ? (S.selection = k = [
              [(u = n === yh ? C : D[0]), (l = n === gh ? P : D[1])],
              [(d = n === yh ? z : u), (v = n === gh ? R : l)],
            ])
        ...
        var O = ct(w).attr("pointer-events", "none"),
          Y = O.selectAll(".overlay").attr("cursor", bh[M]);
        if (t.event.touches)
      ...
      return (
        (function (t, n, r) {
          ...
          var u,
            ...
            d = new Array(),
            p = new Array();
          (u = f = -1), (s = t[0] >= n), Uh[s << 1].forEach(a);
          for (; ++u < i - 1; )
          ...
          for (; ++f < o - 1; ) {
            for (
              ...
              (c = s),
                ...
                (h = l),
                (l = t[f * i + u + 1] >= n),
                Uh[c | (s << 1) | (l << 2) | (h << 3)].forEach(a);
            Uh[s | (l << 3)].forEach(a);
          }
          (u = -1), (l = t[f * i] >= n), Uh[l << 2].forEach(a);
          for (; ++u < i - 1; )
            (h = l),
              (l = t[f * i + u + 1] >= n),
              Uh[(l << 2) | (h << 3)].forEach(a);
          Uh[l << 3].forEach(a);
        })(t, n, function (e) {
          f(e, t, n),
            (function (t) {
    ...
    function n(t, n) {
      function e() {
        ...
        var n,
          e,
          r = u;
        if (t.charCodeAt(r) === Yh) {
          for (
            ;
            (u++ < a && t.charCodeAt(u) !== Yh) || t.charCodeAt(++u) === Yh;
          ...
          return (
            (n = u) >= a
              ...
              : (e = t.charCodeAt(u++)) === Bh
              ? (s = !0)
              : e === Fh && ((s = !0), t.charCodeAt(u) === Bh && ++u),
            t.slice(r + 1, n - 1).replace(/""/g, '"')
          );
        }
        for (; u < a; ) {
          if ((e = t.charCodeAt((n = u++))) === Bh) s = !0;
          else if (e === Fh) (s = !0), t.charCodeAt(u) === Bh && ++u;
      ...
      var r,
        ...
        s = !1;
      for (
        t.charCodeAt(a - 1) === Bh && --a, t.charCodeAt(a - 1) === Fh && --a;
        (r = e()) !== Oh;

      ) {
        for (var l = []; r !== qh && r !== Oh; ) l.push(r), (r = e());
  ...
  function nr(t) {
    if (!(n = ad.exec(t))) throw new Error("invalid format: " + t);
    var n;
    (this.fill = n[1] || " "),
      (this.align = n[2] || ">"),
      (this.sign = n[3] || "-"),
  ...
  function or(n) {
    return (
      (fd = ir(n)),
      (t.format = fd.format),
      (t.formatPrefix = fd.formatPrefix),
      fd
    );
  }
  function ar(t) {
  ...
  function Cr(t) {
    var n = up(t[0] * t[0] + t[1] * t[1] + t[2] * t[2]);
    (t[0] /= n), (t[1] /= n), (t[2] /= n);
  }
  function Pr(t, n) {
    Ad.push((Td = [(gd = t), (_d = t)])),
      n < yd && (yd = n),
      n > bd && (bd = n);
  }
  function zr(t, n) {
    ...
    if (Md) {
      ...
      c ^ (u * md < f && f < u * t)
        ...
        c
          ? t < md
            ? Or(gd, t) > Or(gd, _d) && (_d = t)
            : Or(t, _d) > Or(gd, _d) && (gd = t)
          : _d >= gd
          ? (t < gd && (gd = t), t > _d && (_d = t))
          : t > md
          ? Or(gd, t) > Or(gd, _d) && (_d = t)
          : Or(t, _d) > Or(gd, _d) && (gd = t);
    } else Ad.push((Td = [(gd = t), (_d = t)]));
    n < yd && (yd = n), n > bd && (bd = n), (Md = e), (md = t);
  }
  function Rr() {
    vp.point = zr;
  }
  ...
  function Dr(t, n) {
    if (Md) {
      var e = t - md;
      pp.add(Qd(e) > 180 ? e + (e > 0 ? 360 : -360) : e);
    } else (xd = t), (wd = n);
    dp.point(t, n), zr(t, n);
  }
  function Ur() {
  ...
  function Wr(t, n) {
    (qd = t), (Od = n), (t *= Zd), (n *= Zd), (gp.point = Zr);
    var e = tp(n);
    (Yd = e * tp(t)), (Bd = e * op(t)), (Fd = op(n)), Ir(Yd, Bd, Fd);
  }
  function Zr(t, n) {
    t *= Zd;
    var e = tp((n *= Zd)),
  ...
  function ri(t, n) {
    function e(t, n) {
      var e = tp(n),
        ...
        c = op(n),
        s = c * r + u * i;
      return [Kd(f * o - s * a, u * r - c * i), dr(s * o + f * a)];
    }
    var r = tp(t),
      i = op(t),
      o = tp(n),
    ...
    return (
      (e.invert = function (t, n) {
        var e = tp(n),
          ...
          c = op(n),
          s = c * o - f * a;
        return [Kd(f * o + c * a, u * r + s * i), dr(s * r - u * i)];
      }),
      e
    );
  }
  function ii(t) {
    ...
    return (
      (t = ti(t[0] * Zd, t[1] * Zd, t.length > 2 ? t[2] * Zd : 0)),
      (n.invert = function (n) {
        return (
          (n = t.invert(n[0] * Zd, n[1] * Zd)), (n[0] *= Wd), (n[1] *= Wd), n
        );
      }),
      n
    );
  ...
  function hi(t, n) {
    var e = n[0],
      ...
      a = 0,
      u = 0;
    Ep.reset(), 1 === i ? (r = Gd + jd) : -1 === i && (r = -Gd - jd);
  ...
  function vi(t, n) {
    return (
      ((t = t.x)[0] < 0 ? t[1] - Gd - jd : Gd - t[1]) -
      ((n = n.x)[0] < 0 ? n[1] - Gd - jd : Gd - n[1])
    );
  }
  function gi(t) {
    function n(t, n) {
        ...
        return {
          ...
          point: function (l, h) {
            var d,
              p = [l, h],
              v = n(l, h),
              g = a ? (v ? 0 : r(l, h)) : v ? r(l + (l < 0 ? Xd : -Xd), h) : 0;
            if (
              (!i && (c = f = v) && t.lineStart(),
              v !== f &&
                (!(d = e(i, p)) || fi(i, d) || fi(p, d)) &&
                ((p[0] += jd), (p[1] += jd), (v = n(p[0], p[1]))),
              v !== f)
            )
              (s = 0),
                v
    ...
    return function (a) {
      ...
      function c(o, a) {
        ...
        if ((l && h.push([o, a]), m))
          ...
          var f = [
              (g = Math.max(Pp, Math.min(Cp, g))),
              (_ = Math.max(Pp, Math.min(Cp, _))),
            ],
            c = [
              (o = Math.max(Pp, Math.min(Cp, o))),
              (a = Math.max(Pp, Math.min(Cp, a))),
            ];
  ...
  function mi(t, n) {
    ...
    var e = op((n *= Zd)),
      ...
      u = bp * e - _p * r * o,
      f = _p * e + bp * r * o;
    zp.add(Kd(up(a * a + u * u), f)), (yp = t), (_p = e), (bp = r);
  }
  function xi(t) {
  ...
  function Pi() {
    ...
    function n() {
      return s(np(o / y) * y, i, y)
        .map(d)
        .concat(s(np(c / _) * _, f, _).map(p))
        .concat(
          s(np(r / v) * v, e, v)
            .filter(function (t) {
              return Qd(t % y) > jd;
    ...
    return +n
      ? (function (t, n) {
          function e(r, i, o, a, u, f, c, s, l, h, d, p, v, g) {
            ...
            if (b > 4 * n && v--) {
              var m = a + h,
                ...
                A = dr((w /= M)),
                T =
                  Qd(Qd(w) - 1) < jd || Qd(o - l) < jd ? (o + l) / 2 : Kd(x, m),
                N = t(T, A),
                S = N[0],
                E = N[1],
                k = S - r,
          ...
          return function (n) {
            ...
            function c() {
              e(y, _, g, b, m, x, l, h, s, d, p, v, cv, n),
                (w.lineEnd = a),
                a();
            }
            var s,
  ...
  function co(t, n) {
    function e(t, n) {
      var e = up(o - 2 * i * op(n)) / i;
      return [e * op((t *= i)), a - e * tp(t)];
    }
    var r = op(t),
      i = (r + op(n)) / 2;
    if (Qd(i) < jd)
  ...
  function _o(t, n) {
    function e(t, n) {
      o > 0 ? n < -Gd + jd && (n = -Gd + jd) : n > Gd - jd && (n = Gd - jd);
      var e = o / ip(yo(n), i);
      return [e * op(i * t), o - e * tp(i * t)];
    }
    var r = tp(t),
    ...
    return i
      ? ((e.invert = function (t, n) {
          var e = o - n,
            r = ap(i) * up(t * t + e * e);
          return [(Kd(t, Qd(e)) / i) * ap(e), 2 * Jd(ip(o / r, 1 / i)) - Gd];
        }),
        e)
      : vo;
  }
  ...
  function mo(t, n) {
    ...
    return Qd(i) < jd
      ...
      : ((e.invert = function (t, n) {
          var e = o - n;
          return [(Kd(t, Qd(e)) / i) * ap(e), o - ap(i) * up(t * t + e * e)];
        }),
        e);
  }
  function xo(t, n) {
  ...
  function Fa() {
    ...
    return (
      (t.domain = function (i) {
        return arguments.length
          ? ((n = kv.call(i)), (r = Math.min(n.length, e.length - 1)), t)
          : n.slice();
      }),
      (t.range = function (i) {
        return arguments.length
          ? ((e = kv.call(i)), (r = Math.min(n.length, e.length - 1)), t)
          : e.slice();
      }),
      (t.invertExtent = function (t) {
        var r = e.indexOf(t);
    ...
    return (
      ...
      e &&
        ((i.count = function (n, r) {
          return (
            zv.setTime(+n), Rv.setTime(+r), t(zv), t(Rv), Math.floor(e(zv, Rv))
          );
        }),
        (i.every = function (t) {
          return (
  ...
  function ja(t) {
    return Ia(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Uv) / qv
        );
      }
    );
  }
    ...
    function r(t, n, e, r) {
      for (var i, o, a = 0, u = n.length, f = e.length; a < u; ) {
        ...
        if (37 === (i = n.charCodeAt(a++))) {
          if (
            ((i = n.charAt(a++)),
            !(o = A[i in Dg ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0)
          )
            return -1;
  ...
  function ku(t, n) {
    var e = t.getDay();
    return (
      (t = e >= 4 || 0 === e ? Zv(t) : Zv.ceil(t)),
      Wa(Zv.count(fg(t), t) + (4 === fg(t).getDay()), n, 2)
    );
  }
  function Cu(t) {
    return t.getDay();
  ...
  function Gu(t, n) {
    var e = t.getUTCDay();
    return (
      (t = e >= 4 || 0 === e ? mg(t) : mg.ceil(t)),
      Wa(mg.count(zg(t), t) + (4 === zg(t).getUTCDay()), n, 2)
    );
  }
  function Vu(t) {
    return t.getUTCDay();
  ...
  function nf(n) {
    return (
      (Rg = $a(n)),
      (t.timeFormat = Rg.format),
      (t.timeParse = Rg.parse),
      (t.utcFormat = Rg.utcFormat),
      (t.utcParse = Rg.utcParse),
      Rg
    );
  }
  function ef(t) {
  ...
  function wf() {
    ...
    return (
      (t.x = function (e) {
        return arguments.length
          ? ((n = "function" == typeof e ? e : sf(+e)), t)
          : n;
      }),
      (t.y = function (n) {
        return arguments.length
          ? ((e = "function" == typeof n ? n : sf(+n)), t)
          : e;
      }),
      (t.defined = function (n) {
        return arguments.length
          ? ((r = "function" == typeof n ? n : sf(!!n)), t)
          : r;
      }),
      (t.curve = function (n) {
  ...
  function Mf() {
    ...
    return (
      (t.x = function (n) {
        return arguments.length
          ? ((e = "function" == typeof n ? n : sf(+n)), (r = null), t)
          : e;
      }),
      (t.x0 = function (n) {
        return arguments.length
      ...
      (t.x1 = function (n) {
        return arguments.length
          ? ((r = null == n ? null : "function" == typeof n ? n : sf(+n)), t)
          : r;
      }),
      (t.y = function (n) {
        return arguments.length
          ? ((i = "function" == typeof n ? n : sf(+n)), (o = null), t)
          : i;
      }),
      (t.y0 = function (n) {
        return arguments.length
          ? ((i = "function" == typeof n ? n : sf(+n)), t)
          : i;
      }),
      (t.y1 = function (n) {
        return arguments.length
          ? ((o = null == n ? null : "function" == typeof n ? n : sf(+n)), t)
          : o;
      }),
  ...
  function Lf(t) {
    ...
    return (
      ...
      (n.x = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : sf(+t)), n)
          : i;
      }),
      (n.y = function (t) {
        return arguments.length
          ? ((o = "function" == typeof t ? t : sf(+t)), n)
          : o;
      }),
  ...
  function tc(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      u = (o * i + a * r) / (r + i);
    return (
      (Kf(o) + Kf(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) ||
      0
    );
  }
  function nc(t, n) {
  ...
  function wc(t, n, e, r) {
    ...
    return (
      ...
      e && Ac(i, t, n, e),
      r && Ac(i, n, t, r),
      tb[t.index].halfedges.push(o),
      tb[n.index].halfedges.push(o),
      i
    );
  }
  function Mc(t, n, e) {
  ...
  function Pc(t) {
    var n = t.circle;
    n &&
      (n.P || (J_ = n.N), nb.remove(n), rb.push(n), _c(n), (t.circle = null));
  }
  function zc(t) {
    var n =
      ib.pop() ||
  ...
  function Lc(t) {
    ...
    for (
      var f = o;
      f.circle &&
      Math.abs(e - f.circle.x) < ob &&
      Math.abs(r - f.circle.cy) < ob;
    ...
    for (
      var c = a;
      c.circle &&
      Math.abs(e - c.circle.x) < ob &&
      Math.abs(r - c.circle.cy) < ob;
    ...
    (f = u[0]),
      ((c = u[l - 1]).edge = wc(f.site, c.site, null, i)),
      Cc(f),
      Cc(c);
  }
  function Dc(t) {
    for (var n, e, r, i, o = t[0], a = t[1], u = K_._; u; )
      if ((r = Uc(u, a) - o) > ob) u = u.L;
      else {
        if (
          !(
            (i =
    ...
    var f = zc(t);
    if ((K_.insert(n, f), n || e)) {
      if (n === e)
        return (
          Pc(n),
          (e = zc(n.site)),
          K_.insert(f, e),
          (f.edge = e.edge = wc(n.site, f.site)),
          Cc(n),
          void Cc(e)
        );
      if (e) {
        ...
        Ac(e.edge, c, p, m),
          (f.edge = wc(c, t, null, m)),
          (e.edge = wc(t, p, null, m)),
          Cc(n),
          Cc(e);
  ...
  function Yc(t, n) {
    var e,
      ...
      i,
      o = t.sort(Oc).pop();
    for (eb = [], tb = new Array(t.length), K_ = new yc(), nb = new yc(); ; )
      if (((i = J_), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x))))
        (o[0] === e && o[1] === r) || (Dc(o), (e = o[0]), (r = o[1])),
          (o = t.pop());
      else {
        if (!i) break;
        Lc(i.arc);
    ...
    if (
      ((function () {
        for (var t, n, e, r, i = 0, o = tb.length; i < o; ++i)
          if ((t = tb[i]) && (r = (n = t.halfedges).length)) {
            var a = new Array(r),
              u = new Array(r);
            for (e = 0; e < r; ++e) (a[e] = e), (u[e] = Sc(t, eb[n[e]]));
            for (
              a.sort(function (t, n) {
                return u[n] - u[t];
              }),
      ...
      (function (t, n, e, r) {
        for (var i, o = eb.length; o--; )
          (Nc((i = eb[o]), t, n, e, r) &&
            Tc(i, t, n, e, r) &&
            (Math.abs(i[0][0] - i[1][0]) > ob ||
              Math.abs(i[0][1] - i[1][1]) > ob)) ||
            delete eb[o];
      })(a, u, f, c),
        (function (t, n, e, r) {
          var i,
            ...
            if ((o = tb[i])) {
              ...
              for (u = 0, c = f.length; u < c; )
                (p = (d = kc(o, eb[f[u]]))[0]),
                  ...
                  (l = (s = Ec(o, eb[f[++u % c]]))[0]),
                  (h = s[1]),
                  (Math.abs(p - l) > ob || Math.abs(v - h) > ob) &&
                    (f.splice(
                      u,
                      0,
                      eb.push(
                        Mc(
                          a,
                          d,
                          Math.abs(p - t) < ob && r - v > ob
                            ? [t, Math.abs(l - t) < ob ? h : r]
                            : Math.abs(v - r) < ob && e - p > ob
                            ? [Math.abs(h - r) < ob ? l : e, r]
                            : Math.abs(p - e) < ob && v - n > ob
                            ? [e, Math.abs(l - e) < ob ? h : n]
                            : Math.abs(v - n) < ob && p - t > ob
                            ? [Math.abs(h - n) < ob ? l : t, n]
                            : null
                        )
                      ) - 1
                    ),
  ...
  if ("undefined" != typeof document) {
    var gs = document.documentElement;
    if (!gs.matches) {
      var ys =
        gs.webkitMatchesSelector ||
  ...
  if (((t.event = null), "undefined" != typeof document)) {
    "onmouseenter" in document.documentElement ||
      (ms = { mouseenter: "mouseover", mouseleave: "mouseout" });
  }
  var xs = [null];
  ...
  var Zs,
      ...
      function (t) {
        return "none" === t
          ...
          : (Zs ||
              ...
              (Qs = document.documentElement),
              (Js = document.defaultView)),
            (Zs.style.transform = t),
            (t = Js.getComputedStyle(Qs.appendChild(Zs), null).getPropertyValue(
              "transform"
            )),
            Qs.removeChild(Zs),
            (t = t.slice(7, -1).split(",")),
    ...
    sl = gn(
      function (t) {
        return null == t
          ? fl
          : (Ks ||
              (Ks = document.createElementNS(
                "http://www.w3.org/2000/svg",
                "g"
              )),
            Ks.setAttribute("transform", t),
            (t = Ks.transform.baseVal.consolidate())
    ...
    Nl = 0,
    Sl = 0,
    El = "object" == typeof performance && performance.now ? performance : Date,
    kl =
  ...
  An.prototype = Tn.prototype = {
    ...
    restart: function (t, n, e) {
      ...
      (e = (null == e ? wn() : +e) + (null == n ? 0 : +n)),
        this._next ||
          nl === this ||
          (nl ? (nl._next = this) : (tl = this), (nl = this)),
        (this._call = t),
        (this._time = e),
        kn();
    },
  ...
  var Il = (function t(n) {
    ...
    uh = (function t(n, e) {
      ...
      var i = Math.asin(1 / (n = Math.max(1, n))) * (e /= ah);
      return (
    ...
    sh = { time: null, delay: 0, duration: 250, ease: In };
  (ft.prototype.interrupt = function (t) {
    ...
    (ft.prototype.transition = function (t) {
      ...
      t instanceof On
        ? ((n = t._id), (t = t._name))
        : ((n = Bn()), ((e = sh).time = wn()), (t = null == t ? null : t + ""));
  ...
  or({ decimal: ".", thousands: ",", grouping: [3], currency: ["$", ""] }),
    (sr.prototype = {
      ...
      add: function (t) {
        lr(Id, t, this.t),
          lr(this, Id.s, this.s),
          this.s ? (this.t += Id.t) : (this.s = Id.t);
      },
      valueOf: function () {
        return this.s;
      },
    ...
    nv = {
      ...
      result: function () {
        var t = tv
          ...
          ? [Gp / $p, Vp / $p]
          : [NaN, NaN];
        return (Gp = Vp = $p = Wp = Zp = Qp = Jp = Kp = tv = 0), t;
      },
    };
  Gi.prototype = {
    _radius: 4.5,
      ...
      switch (this._point) {
        ...
        default:
          this._context.moveTo(t + this._radius, n),
            this._context.arc(t, n, this._radius, 0, $d);
      }
    },
    result: vr,
  };
  ...
  var _v = (1 + Math.sqrt(5)) / 2,
    ...
    Mv = (function t(n) {
      function e() {
        var t = wv.source(n).apply(this, arguments);
        return function () {
          return Math.exp(t());
        };
      }
  ...
  var Dv = Lv.range,
    ...
    Iv = Ia(
      function (t) {
        var n = (t.getTimezoneOffset() * Uv) % 36e5;
    ...
    Hv = Ia(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Uv) / 864e5
        );
      },
      function (t) {
        return t.getDate() - 1;
  ...
  var Yg = "%Y-%m-%dT%H:%M:%S.%LZ",
    Bg = Date.prototype.toISOString
      ...
      : t.utcFormat(Yg),
    Fg = +new Date("2000-01-01T00:00:00.000Z")
      ? function (t) {
          var n = new Date(t);
    ...
    e_ = new Array(3)
      ...
      .map(uf),
    r_ = ff(e_),
    i_ = ml(Zt(300, 0.5, 0), Zt(-240, 0.5, 1)),
    o_ = ml(Zt(-100, 0.75, 0.35), Zt(80, 1.5, 0.8)),
    a_ = ml(Zt(260, 0.75, 0.35), Zt(80, 1.5, 0.8)),
    u_ = Zt(),
    f_ = Rt(),
    c_ = Math.PI / 3,
    s_ = (2 * Math.PI) / 3,
    ...
    j_ = {
      draw: function (t, n) {
        ...
        t.moveTo(r, i),
          ...
          t.lineTo(-0.5 * u - B_ * f, B_ * u + -0.5 * f),
          t.lineTo(-0.5 * r + B_ * i, -0.5 * i - B_ * r),
          t.lineTo(-0.5 * o + B_ * a, -0.5 * a - B_ * o),
          t.lineTo(-0.5 * u + B_ * f, -0.5 * f - B_ * u),
          t.closePath();
      },
    },
    H_ = [E_, k_, z_, q_, U_, Y_, j_];
  (Bf.prototype = {
    areaStart: function () {
      this._line = 0;
    },
      ...
      lineEnd: function () {
        switch (this._point) {
          case 2:
            ...
            break;
          case 3:
            ec(this, this._t0, nc(this, this._t0));
        }
        (this._line || (0 !== this._line && 1 === this._point)) &&
          this._context.closePath(),
          (this._line = 1 - this._line);
        ...
        if (((t = +t), (n = +n), t !== this._x1 || n !== this._y1)) {
          switch (this._point) {
            ...
            case 1:
              ...
              break;
            case 2:
              (this._point = 3), ec(this, nc(this, (e = tc(this, t, n))), e);
              break;
            default:
              ec(this, this._t0, (e = tc(this, t, n)));
          }
          (this._x0 = this._x1),
            (this._x1 = t),
            (this._y0 = this._y1),
      ...
      lineEnd: function () {
        ...
        if (e)
          if (
            ...
            for (var r = uc(t), i = uc(n), o = 0, a = 1; a < e; ++o, ++a)
      ...
      insert: function (t, n) {
        ...
        for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
          e === (r = e.U).L
            ? (i = r.R) && i.C
              ? ((e.C = i.C = !1), (r.C = !0), (t = r))
              : (t === e.R && (bc(this, e), (e = (t = e).U)),
                (e.C = !1),
                (r.C = !0),
                mc(this, r))
            : (i = r.L) && i.C
            ? ((e.C = i.C = !1), (r.C = !0), (t = r))
            : (t === e.L && (mc(this, e), (e = (t = e).U)),
              (e.C = !1),
              (r.C = !0),
              bc(this, r)),
            (e = t.U);
          ...
          if (t && t.C) t.C = !1;
            ...
            do {
              ...
              if (t === i.L) {
                if (
                  ((n = i.R).C &&
                    ((n.C = !1), (i.C = !0), bc(this, i), (n = i.R)),
                  (n.L && n.L.C) || (n.R && n.R.C))
                ) {
                  (n.R && n.R.C) ||
                    ((n.L.C = !1), (n.C = !0), mc(this, n), (n = i.R)),
                    (n.C = i.C),
                    (i.C = n.R.C = !1),
                    bc(this, i),
                    (t = this._);
                ...
                ((n = i.L).C &&
                  ((n.C = !1), (i.C = !0), mc(this, i), (n = i.L)),
                (n.L && n.L.C) || (n.R && n.R.C))
              ) {
                (n.L && n.L.C) ||
                  ((n.R.C = !1), (n.C = !0), bc(this, n), (n = i.L)),
                  (n.C = i.C),
                  (i.C = n.L.C = !1),
                  mc(this, i),
                  (t = this._);
  ...
  (Yc.prototype = {
    ...
    (Fc.prototype = {
      ...
      translate: function (t, n) {
        return (0 === t) & (0 === n)
          ? this
          : new Fc(this.k, this.x + this.k * t, this.y + this.k * n);
      },
      apply: function (t) {
  ...
  (Ic.prototype = Fc.prototype),
    ...
    (t.ribbon = function () {
      function t() {
        ...
        if (
          ...
          a.arc(0, 0, s, l, h),
          (l === g && h === y) ||
            (a.quadraticCurveTo(0, 0, v * Ah(g), v * Th(g)),
            a.arc(0, 0, v, g, y)),
    ...
    (t.geoCentroid = function (t) {
      (Nd = Sd = Ed = kd = Cd = Pd = zd = Rd = Ld = Dd = Ud = 0), br(t, gp);
      var n = Ld,
        e = Dd,
        r = Ud,
        i = n * n + e * e + r * r;
      return i < Hd &&
        ...
        (e = zd),
        (r = Rd),
        Sd < jd && ((n = Ed), (e = kd), (r = Cd)),
        (i = n * n + e * e + r * r) < Hd)
        ? [NaN, NaN]
        : [Kd(e, n) * Wd, dr(r / up(i)) * Wd];
    }),
    (t.geoCircle = function () {
      function t() {
        var t = r.apply(this, arguments),
          u = i.apply(this, arguments) * Zd,
          f = o.apply(this, arguments) * Zd;
        return (
          (n = []),
          (e = ti(-t[0] * Zd, -t[1] * Zd, 0).invert),
          oi(a, u, f, 1),
        ...
        g = p
          ? function (t) {
              var n = op((t *= p)) / v,
                ...
                i = e * l + n * d,
                o = e * u + n * c;
              return [Kd(i, r) * Wd, Kd(o, up(r * r + i * i)) * Wd];
            }
          : function () {
              return [e * Wd, r * Wd];
            };
        ...
        (t.translate = function (t) {
          ...
          return (
            ...
            (o = c
              ...
              .clipExtent([
                [r - 0.425 * e + jd, u + 0.12 * e + jd],
                [r - 0.214 * e - jd, u + 0.234 * e - jd],
              ])
              .stream(l)),
            (a = s
              .translate([r - 0.205 * e, u + 0.212 * e])
              .clipExtent([
                [r - 0.214 * e + jd, u + 0.166 * e + jd],
                [r - 0.115 * e - jd, u + 0.234 * e - jd],
              ])
              .stream(l)),
            n()
          );
      ...
      function t(t) {
        ...
        for (i = 0; i < s; ++i)
          (r = t[i]),
            ...
            null != (f = n(r, i, t)) &&
              (f += "") &&
              (h[(c = vv + (u.id = f))] = c in h ? yv : u);
        for (i = 0; i < s; ++i)
          if (((u = l[i]), null != (f = e(t[i], i, t)) && (f += ""))) {
            if (!(a = h[vv + f])) throw new Error("missing: " + f);
            if (a === yv) throw new Error("ambiguous: " + f);
    ...
    (t.treemapSquarify = bv),
    (t.treemapResquarify = mv),
    (t.interpolate = dn),
    ...
    (t.interpolateTransformCss = cl),
    (t.interpolateTransformSvg = sl),
    (t.interpolateZoom = _n),
    (t.interpolateRgb = el),
    (t.interpolateRgbBasis = rl),
    (t.interpolateRgbBasisClosed = il),
    (t.interpolateHsl = vl),
    (t.interpolateHslLong = gl),
    ...
    (t.interpolateHcl = yl),
    (t.interpolateHclLong = _l),
    (t.interpolateCubehelix = bl),
    (t.interpolateCubehelixLong = ml),
    ...
    (t.randomUniform = xv),
    (t.randomNormal = wv),
    (t.randomLogNormal = Mv),
    (t.randomBates = Tv),
    (t.randomIrwinHall = Av),
    (t.randomExponential = Nv),
    (t.scaleBand = ya),
    ...
    (t.scaleTime = function () {
      return of(fg, ag, Gv, Hv, Iv, Bv, Ov, Lv, t.timeFormat).domain([
        new Date(2e3, 0, 1),
        new Date(2e3, 0, 2),
      ]);
    }),
    (t.scaleUtc = function () {
      return of(zg, Cg, gg, pg, hg, sg, Ov, Lv, t.utcFormat).domain([
        Date.UTC(2e3, 0, 1),
        Date.UTC(2e3, 0, 2),
      ]);
    }),
    (t.scaleSequential = af),
    (t.schemeCategory10 = Wg),
    (t.schemeAccent = Zg),
    (t.schemeDark2 = Qg),
    (t.schemePaired = Jg),
    (t.schemePastel1 = Kg),
    ...
    (t.schemeSet2 = ey),
    (t.schemeSet3 = ry),
    (t.interpolateBrBG = oy),
    (t.schemeBrBG = iy),
    (t.interpolatePRGn = uy),
    (t.schemePRGn = ay),
    (t.interpolatePiYG = cy),
    (t.schemePiYG = fy),
    (t.interpolatePuOr = ly),
    (t.schemePuOr = sy),
    (t.interpolateRdBu = dy),
    (t.schemeRdBu = hy),
    (t.interpolateRdGy = vy),
    (t.schemeRdGy = py),
    (t.interpolateRdYlBu = yy),
    (t.schemeRdYlBu = gy),
    (t.interpolateRdYlGn = by),
    (t.schemeRdYlGn = _y),
    (t.interpolateSpectral = xy),
    (t.schemeSpectral = my),
    (t.interpolateBuGn = My),
    (t.schemeBuGn = wy),
    (t.interpolateBuPu = Ty),
    (t.schemeBuPu = Ay),
    (t.interpolateGnBu = Sy),
    (t.schemeGnBu = Ny),
    (t.interpolateOrRd = ky),
    (t.schemeOrRd = Ey),
    (t.interpolatePuBuGn = Py),
    (t.schemePuBuGn = Cy),
    (t.interpolatePuBu = Ry),
    (t.schemePuBu = zy),
    (t.interpolatePuRd = Dy),
    (t.schemePuRd = Ly),
    (t.interpolateRdPu = qy),
    (t.schemeRdPu = Uy),
    (t.interpolateYlGnBu = Yy),
    (t.schemeYlGnBu = Oy),
    (t.interpolateYlGn = Fy),
    (t.schemeYlGn = By),
    (t.interpolateYlOrBr = jy),
    (t.schemeYlOrBr = Iy),
    (t.interpolateYlOrRd = Xy),
    (t.schemeYlOrRd = Hy),
    (t.interpolateBlues = Vy),
    (t.schemeBlues = Gy),
    (t.interpolateGreens = Wy),
    (t.schemeGreens = $y),
    (t.interpolateGreys = Qy),
    (t.schemeGreys = Zy),
    (t.interpolatePurples = Ky),
    (t.schemePurples = Jy),
    (t.interpolateReds = n_),
    (t.schemeReds = t_),
    (t.interpolateOranges = r_),
    (t.schemeOranges = e_),
    (t.interpolateCubehelixDefault = i_),
    ...
    (t.interpolateWarm = o_),
    (t.interpolateCool = a_),
    (t.interpolateSinebow = function (t) {
      var n;
      return (
        (t = (0.5 - t) * Math.PI),
        (f_.r = 255 * (n = Math.sin(t)) * n),
        (f_.g = 255 * (n = Math.sin(t + c_)) * n),
        (f_.b = 255 * (n = Math.sin(t + s_)) * n),
        f_ + ""
      );
    }),
    (t.interpolateViridis = l_),
    (t.interpolateMagma = h_),
    (t.interpolateInferno = d_),
    (t.interpolatePlasma = p_),
    (t.create = function (t) {
    ...
    (t.arc = function () {
      function t() {
        var t,
          ...
          p = v_(d - h),
          v = d > h;
        if ((f || (f = t = oe()), l < s && ((c = l), (l = s), (s = c)), l > w_))
          if (p > T_ - w_)
            f.moveTo(l * y_(h), l * m_(h)),
              f.arc(0, 0, l, h, d, !v),
              s > w_ &&
                (f.moveTo(s * y_(d), s * m_(d)), f.arc(0, 0, s, d, h, v));
          else {
            var g,
              y,
              _ = h,
                  ...
                  H =
                    ...
                    m_(
                      (function (t) {
                        ...
                        (B * I + F * j) /
                          (x_(B * B + F * F) * x_(I * I + j * j))
                      ) / 2
                    ),
                  X = x_(Y[0] * Y[0] + Y[1] * Y[1]);
                (S = b_(N, (s - X) / (H - 1))), (E = b_(N, (l - X) / (H + 1)));
              }
            }
            M > w_
              ? E > w_
                  ...
                  E < N
                    ...
                    : (f.arc(
                      ...
                      f.arc(
                        ...
                        0,
                        l,
                        g_(g.cy + g.y11, g.cx + g.x11),
                        g_(y.cy + y.y11, y.cx + y.x11),
                        !v
                      ),
                      f.arc(
                        y.cx,
      ...
      return (
        ...
        (t.padRadius = function (n) {
          return arguments.length
            ? ((i = null == n ? null : "function" == typeof n ? n : sf(+n)), t)
            : i;
        }),
        (t.startAngle = function (n) {
          return arguments.length
            ? ((o = "function" == typeof n ? n : sf(+n)), t)
            : o;
        }),
        (t.endAngle = function (n) {
          return arguments.length
    ...
    (t.curveBundle = X_),
    (t.curveCardinalClosed = V_),
    (t.curveCardinalOpen = $_),
    (t.curveCardinal = G_),
    (t.curveCatmullRomClosed = Z_),
    (t.curveCatmullRomOpen = Q_),
    (t.curveCatmullRom = W_),
    ...
    (t.stack = function () {
      ...
      return (
        (t.keys = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : sf(S_.call(e))), t)
            : n;
        }),
        (t.value = function (n) {
          return arguments.length
        ...
        (t.order = function (n) {
          return arguments.length
            ? ((e =
                null == n ? sc : "function" == typeof n ? n : sf(S_.call(n))),
              t)
            : e;
        }),
        (t.offset = function (n) {
    ...
    (t.timeInterval = Ia),
    (t.timeMillisecond = Lv),
    (t.timeMilliseconds = Dv),
    (t.utcMillisecond = Lv),
    (t.utcMilliseconds = Dv),
    (t.timeSecond = Ov),
    (t.timeSeconds = Yv),
    (t.utcSecond = Ov),
    (t.utcSeconds = Yv),
    ...
    (t.active = function (t, n) {
      ...
      if (i) {
        n = null == n ? null : n + "";
        for (r in i)
          if ((e = i[r]).state > Rl && e.name === n)
            return new On([[t]], lh, n, +r);
      }
      return null;
    }),
    (t.interrupt = Dn),
    (t.voronoi = function () {
      function t(t) {
        return new Yc(
          t.map(function (r, i) {
            var o = [
              Math.round(n(r, i, t) / ob) * ob,
              Math.round(e(r, i, t) / ob) * ob,
            ];
      ...
      return (
        ...
        (t.x = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : pc(+e)), t)
            : n;
        }),
        (t.y = function (n) {
          return arguments.length
            ? ((e = "function" == typeof n ? n : pc(+n)), t)
            : e;
        }),
        (t.extent = function (n) {
          return arguments.length
    ...
    (t.zoom = function () {
      ...
      function r(t, n, e) {
        var r = n[0] - e[0] * t.k,
          i = n[1] - e[1] * t.k;
        return r === t.x && i === t.y ? t : new Fc(t.k, r, i);
      }
      function i(t) {
          ...
          .tween("zoom", function () {
            ...
            return function (t) {
              if (1 === t) t = s;
                ...
                var n = l(t),
                  e = f / n[2];
                t = new Fc(e, u[0] - n[0] * e, u[1] - n[1] * e);
              }
              r.zoom(null, t);
            };
          });
      ...
      function h() {
        var n,
          ...
          s = c.length;
        for (Hc(), p && (p = clearTimeout(p)), n = 0; n < s; ++n)
      ...
      return (
        ...
        (n.wheelDelta = function (t) {
          return arguments.length
            ? ((b = "function" == typeof t ? t : Bc(+t)), n)
            : b;
        }),
        (n.filter = function (t) {
          return arguments.length
            ? ((g = "function" == typeof t ? t : Bc(!!t)), n)
            : g;
        }),
        (n.touchable = function (t) {
          return arguments.length
            ? ((m = "function" == typeof t ? t : Bc(!!t)), n)
            : m;
        }),
        (n.extent = function (t) {
          return arguments.length
