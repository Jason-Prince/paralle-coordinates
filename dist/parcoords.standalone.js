...
(function (global, factory) {
  ...
  function drag() {
    ...
    drag.filter = function (_) {
      return arguments.length
        ? ((filter = typeof _ === "function" ? _ : constant$1(!!_)), drag)
        : filter;
    };

    drag.container = function (_) {
      return arguments.length
        ? ((container = typeof _ === "function" ? _ : constant$1(_)), drag)
        : container;
    };

    drag.subject = function (_) {
      return arguments.length
        ? ((subject = typeof _ === "function" ? _ : constant$1(_)), drag)
        : subject;
    };

    drag.touchable = function (_) {
      return arguments.length
        ? ((touchable = typeof _ === "function" ? _ : constant$1(!!_)), drag)
        : touchable;
    };
  ...
  function color$1(format) {
    ...
    return (m = reHex3$1.exec(format))
      ...
      : (m = reHex6$1.exec(format))
      ? rgbn$1(parseInt(m[1], 16)) // #ff0000
  ...
  function labConvert$1(o) {
    ...
    var b = rgb2xyz(o.r),
      ...
      y = xyz2lab$1((0.2126729 * b + 0.7151522 * a + 0.072175 * l) / Yn$1),
      z = xyz2lab$1((0.0193339 * b + 0.119192 * a + 0.9503041 * l) / Zn$1);
  ...
  function lab$2(l, a, b, opacity) {
    return arguments.length === 1
      ? labConvert$1(l)
      : new Lab$1(l, a, b, opacity == null ? 1 : opacity);
  }
  ...
  function hcl$3(h, c, l, opacity) {
    return arguments.length === 1
      ? hclConvert$1(h)
      : new Hcl$1(h, c, l, opacity == null ? 1 : opacity);
  }
  ...
  function cubehelix$3(h, s, l, opacity) {
    return arguments.length === 1
      ? cubehelixConvert$1(h)
      : new Cubehelix$1(h, s, l, opacity == null ? 1 : opacity);
  }
      ...
      : this.styleTween(
          ...
          typeof value$$1 === "function"
            ? styleFunction$1(
                name,
                i,
                tweenValue(this, "style." + name, value$$1)
              )
  ...
  function brush$1(dim) {
    ...
    function started() {
      ...
      var that = this,
        ...
        mode =
          (event.metaKey ? (type = "overlay") : type) === "selection"
            ? MODE_DRAG
            : event.altKey
            ? MODE_CENTER
            : MODE_HANDLE,
    ...
    brush.filter = function (_) {
      return arguments.length
        ? ((filter = typeof _ === "function" ? _ : constant$3(!!_)), brush)
        : filter;
    };
    ...
    return function (extents) {
      ...
      if (typeof extents === "undefined") {
        return Object.keys(config.dimensions).reduce(function (acc, cur) {
          ...
          if (
            brush$$1 !== undefined &&
            brushSelection(brushNodes[cur]) !== null
          ) {
        ...
        Object.keys(config.dimensions).forEach(function (d) {
          ...
          if (brush$$1 !== undefined) {
            ...
            brushSelections[d]
              .call(brush$$1)
              .call(brush$$1.move, yExtent.reverse());
  ...
  var brushFor = function brushFor(state, config, pc, events, brushGroup) {
    return function (axis, _selector) {
      ...
      var _brush = brushY(_selector).extent([
        [-15, 0],
        [15, brushRangeMax],
      ]);
  ...
  var drawBrushes = function drawBrushes(
    brushes,
    config,
    pc,
    axis,
    ...
    brushSelection
      ...
      .attr("id", function (b) {
        return (
          "brush-" + Object.keys(config.dimensions).indexOf(axis) + "-" + b.id
        );
      })
    ...
    var within = {
      date: function date(d, p, i) {
        ...
        if (typeof config.dimensions[p].yscale.bandwidth === "function") {
          ...
          try {
            for (
              var _iterator = dimExt[Symbol.iterator](), _step;
          ...
          try {
            for (
              var _iterator2 = dimExt[Symbol.iterator](), _step2;
      ...
      number: function number(d, p, i) {
        ...
        if (typeof config.dimensions[p].yscale.bandwidth === "function") {
          ...
          try {
            for (
              var _iterator3 = dimExt[Symbol.iterator](), _step3;
          ...
          try {
            for (
              var _iterator4 = dimExt[Symbol.iterator](), _step4;
      ...
      string: function string(d, p, i) {
        ...
        try {
          for (
            var _iterator5 = dimExt[Symbol.iterator](), _step5;
      ...
      brush$$1
        ...
        .on("brush", function (e) {
          ...
          brushUpdated$1(
            ...
            pc,
            events
          )(selected$1(state, config, pc, events, brushGroup));
        })
        .on("end", function () {
          // Figure out if our latest brush has a selection
          var lastBrushID = brushes[axis][brushes[axis].length - 1].id;
          var lastBrush = document.getElementById(
            "brush-" +
   ...
   * @returns {Function}
   */
  var brushExtents$1 = function brushExtents(
    state,
    config,
    pc,
    events,
          ...
          Object.keys(config.dimensions).forEach(function (d, pos) {
            ...
            if (axisBrush) {
              axisBrush.forEach(function (e, i) {
                var brush$$1 = document.getElementById(
                  "brush-" + pos + "-" + i
                );
                if (brush$$1 && brushSelection(brush$$1) !== null) {
                  pc.g()
  ...
  var uninstall$1 = function uninstall(state, pc) {
    return function () {
      if (pc.g() !== undefined && pc.g() !== null)
        pc.g().selectAll(".brush-group").remove();
  ...
  var install1DMultiAxes = function install1DMultiAxes(
    brushGroup,
    config,
    pc,
    events
  ...
  var drawStrum = function drawStrum(
    brushGroup,
    state,
    config,
    pc,
  ...
  var brushReset$2 = function brushReset(
    brushGroup,
    state,
    config,
    pc,
  ...
  var consecutive = function consecutive(dimensions) {
    return function (first, second) {
      ...
      return keys.some(function (d, i) {
        return d === first
          ? i + i < keys.length && dimensions[i + 1] === second
          : false;
      });
    };
  };

  var install$2 = function install(
    brushGroup,
    state,
    config,
    pc,
    ...
    return function () {
      ...
      state.strums.width = function (id) {
        return state.strums[id] === undefined
          ? undefined
  ...
  var drawStrum$1 = function drawStrum(
    brushGroup,
    state,
    config,
    pc,
  ...
  function d3Arc() {
    ...
    arc.innerRadius = function (_) {
      return arguments.length
        ? ((innerRadius = typeof _ === "function" ? _ : constant$4(+_)), arc)
        : innerRadius;
    };

    arc.outerRadius = function (_) {
      return arguments.length
        ? ((outerRadius = typeof _ === "function" ? _ : constant$4(+_)), arc)
        : outerRadius;
    };

    arc.cornerRadius = function (_) {
      return arguments.length
        ? ((cornerRadius = typeof _ === "function" ? _ : constant$4(+_)), arc)
        : cornerRadius;
    };
    ...
    arc.padRadius = function (_) {
      return arguments.length
        ? ((padRadius =
            _ == null ? null : typeof _ === "function" ? _ : constant$4(+_)),
          arc)
        : padRadius;
    };
    ...
    arc.startAngle = function (_) {
      return arguments.length
        ? ((startAngle = typeof _ === "function" ? _ : constant$4(+_)), arc)
        : startAngle;
    };

    arc.endAngle = function (_) {
      return arguments.length
        ? ((endAngle = typeof _ === "function" ? _ : constant$4(+_)), arc)
        : endAngle;
    };

    arc.padAngle = function (_) {
      return arguments.length
        ? ((padAngle = typeof _ === "function" ? _ : constant$4(+_)), arc)
        : padAngle;
    };
  ...
  var brushReset$3 = function brushReset(
    brushGroup,
    state,
    config,
    pc,
  ...
  var install$3 = function install(
    brushGroup,
    state,
    config,
    pc,
    ...
    return function () {
      ...
      _drag
        .on("start", onDragStart$1(state, config, pc, xscale))
        .on("drag", onDrag$1(brushGroup, state, config, pc, events))
        .on("end", onDragEnd$1(brushGroup, state, config, pc, events));
  ...
  var mergeParcoords = function mergeParcoords(pc) {
    return function (callback) {
      ...
      var canvasMarginLeft = Number(
        foregroundCanvas.style.marginLeft.replace("px", "")
      );

      var textTopAdjust = 15;
      var canvasMarginTop =
        Number(foregroundCanvas.style.marginTop.replace("px", "")) +
        textTopAdjust;
      var width =
    ...
    return function () {
      ...
      if (config.brushes.length === 0) {
            ...
            if (
              ...
              for (var i = 0; i < ranger.length; i++) {
                if (
                  ...
                  values.push(
                    config.dimensions[nodes[k].__data__].yscale.invert(
                      ranger[i]
                    )
                  );
                } else if (
                  config.dimensions[nodes[k].__data__].yscale() !== 1
                ) {
                  values.unshift(
                    config.dimensions[nodes[k].__data__].yscale.invert(
                      ranger[i]
              ...
              var dimRange = config.dimensions[
                nodes[k].__data__
              ].yscale.range();
              var dimDomain = config.dimensions[
                nodes[k].__data__
              ].yscale.domain();
        ...
        var within = {
          date: function date(d, p, dimension) {
            var category = d[p];
            var categoryIndex = config.dimensions[p].yscale
              .domain()
              .indexOf(category);
            var categoryRangeValue = config.dimensions[p].yscale.range()[
              categoryIndex
            ];
            return (
        ...
        var _loop = function _loop(idx) {
          ...
          if (
            typeof config.dimensions[brush$$1.data].yscale.domain()[0] ===
            "number"
          ) {
            for (var _i = 0; _i < ranger.length; _i++) {
              if (
                actives.includes(brush$$1.data) &&
                config.flipAxes.includes(brush$$1.data)
              ) {
                values.push(
                  config.dimensions[brush$$1.data].yscale.invert(ranger[_i])
                );
            ...
            for (var _j = 0; _j < _dimRange.length; _j++) {
              if (
                _dimRange[_j] >= ranger[0] &&
                _dimRange[_j] <= ranger[1] &&
                actives.includes(brush$$1.data) &&
                config.flipAxes.includes(brush$$1.data)
              ) {
  ...
  var updateAxes = function updateAxes(config, pc, position, axis, flags) {
    return function () {
      ...
      g_data
        ...
        .each(function (d) {
          var axisElement = select(this).call(
  ...
  function continuous(deinterpolate, reinterpolate) {
    ...
    scale.range = function (_) {
      return arguments.length
        ? ((range$$1 = slice$2.call(_)), rescale())
        : range$$1.slice();
    };

    scale.rangeRound = function (_) {
      return (
        (range$$1 = slice$2.call(_)),
    ...
    return function () {
      ...
      var defaultScales = {
        ...
        string: function string(k) {
          ...
          config.data.map(function (p) {
            if (
              p[k] === undefined &&
              config.nullValueSeparator !== "undefined"
            ) {
          ...
          if (config.flipAxes.includes(k)) {
            ...
            for (
              var i = 0;
              i < Object.getOwnPropertyNames(counts).length;
              i++
            ) {
      ...
      Object.keys(config.dimensions).forEach(function (k) {
        if (
          ...
          config.dimensions[k].yscale = defaultScales[
            config.dimensions[k].type
          ](k);
        }
      });
            ...
            select(this).call(
              config.dimensions[d]["brush"]
                ...
                .on("end", function () {
                  ...
                  if (event.sourceEvent.ctrlKey) {
                    var html = select(this).select(".selection").nodes()[0]
                      .outerHTML;
                    html = html.replace(
                      'class="selection"',
  ...
  function axis(orient, scale) {
    ...
    axis.tickArguments = function (_) {
      return arguments.length
        ? ((tickArguments = _ == null ? [] : slice$3.call(_)), axis)
        : tickArguments.slice();
    };

    axis.tickValues = function (_) {
      return arguments.length
        ? ((tickValues = _ == null ? null : slice$3.call(_)), axis)
  ...
  var reorderable = function reorderable(
    config,
    pc,
    xscale,
    position,
  ...
  var sortDimensions = function sortDimensions(config, position) {
    return function () {
      ...
      var positionSortedKeys = Object.keys(config.dimensions).sort(function (
        a,
        b
      ) {
      ...
      },
      {
        ...
        value: function minor(a, b, c, d) {
          ...
          while (ni--) {
            ...
            while (nj--) {
              j = d - nj - 1;
              elements[i][j] = this.elements[(a + i - 1) % rows][
                (b + j - 1) % cols
              ];
            }
          }
  ...
  var computeCentroids = function computeCentroids(config, position, row) {
    ...
    for (var i = 0; i < cols; ++i) {
      ...
      if (i < cols - 1) {
        ...
        var cy =
          y + a * (config.dimensions[p[i + 1]].yscale(row[p[i + 1]]) - y);
        if (config.bundleDimension !== null) {
          var leftCentroid = config.clusterCentroids
            .get(
            ...
            .get(p[i]);
          var rightCentroid = config.clusterCentroids
            .get(
              config.dimensions[config.bundleDimension].yscale(
                row[config.bundleDimension]
              )
  ...
  var computeControlPoints = function computeControlPoints(
    smoothness,
    centroids
  ) {
  ...
  var renderMarkedDefault = function renderMarkedDefault(
    config,
    pc,
    ctx,
    position
  ...
  var renderBrushedDefault = function renderBrushedDefault(
    config,
    ctx,
    position,
    pc,
  ...
  var renderBrushedQueue = function renderBrushedQueue(
    config,
    brushGroup,
    brushedQueue
  ) {
  ...
  var renderDefaultQueue = function renderDefaultQueue(
    config,
    pc,
    foregroundQueue
  ) {
  ...
  var getOrderedDimensionKeys = function getOrderedDimensionKeys(config) {
    return function () {
      return Object.keys(config.dimensions).sort(function (x, y) {
        return ascending$2(
          config.dimensions[x].index,
          config.dimensions[y].index
        );
      });
    };
  };
  ...
  var init$1 = function init(config, canvas, ctx) {
    ...
    var pc = function pc(selection$$1) {
      ...
      // canvas data layers
      ["dots", "foreground", "brushed", "marked", "highlight"].forEach(
        function (layer) {
          canvas[layer] = selection$$1
            .append("canvas")
            .attr("class", layer)
            .node();
  ...
  var computeClusterCentroids = function computeClusterCentroids(config, d) {
    ...
    config.data.forEach(function (row) {
      Object.keys(config.dimensions).map(function (p) {
        ...
        value +=
          config.dimensions[p].yscale(row[p]) / clusterCounts.get(scaled);
  ...
  var sideEffects = function sideEffects(
    config,
    ctx,
    pc,
    xscale,
    ...
    return dispatch
      .apply(_this$5, Object.keys(config))
  ...
  var ParCoords = function ParCoords(userConfig) {
    ...
    var brushedQueue = renderQueue(pathBrushed(config, ctx, position))
      .rate(50)
      .clear(function () {
        return pc.clear("brushed");
      });

    var markedQueue = renderQueue(pathMark(config, ctx, position))
      .rate(50)
      .clear(function () {
        return pc.clear("marked");
      });

    var foregroundQueue = renderQueue(pathForeground(config, ctx, position))
      .rate(50)
      .clear(function () {
        pc.clear("foreground");
        pc.clear("highlight");
